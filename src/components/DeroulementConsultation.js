...
export default function DeroulementConsultation() {
  return (
    <div class="py-16 bg-gold-50 overflow-hidden lg:py-24">
      <div class="relative max-w-xl mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-7xl">
        ...
        <div class="relative">
          <h2 class="text-center text-3xl leading-8 font-extrabold tracking-tight text-gold-600 sm:text-4xl">
        ...
        <div class="relative mt-12 lg:mt-24 lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
          <div class="relative">
            <dl class="mt-10 space-y-10">
              <div class="relative">
                <dt>
                  <div class="absolute flex items-center justify-center h-12 w-12 rounded-md bg-gold-500 text-white">
                    <svg
                      class="h-6 w-6"
                  ...
                  <p class="ml-16 text-lg leading-6 font-medium text-gold-600">
                    Examen clinique
                  </p>
                </dt>
